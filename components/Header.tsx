        ...
        <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none">
          ...
          >
            ...
            <span className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-sm">
              {/* Replace with actual item count from global state */}
              {itemCount}
            </span>
            {/* Span item count onece global state is implemented */}
            <span>My Basket</span>
          </Link>

          {/* user area */}
          <ClerkLoaded>
            {/* show this if user not loggin */}
            {user && (
              <SignedIn>
                <Link
                  href="/orders"
